namespace Time_Line.API.Controllers
{
    ...
    public class PostsController : ControllerBase
    {
        ...
        [HttpPost("[action]")]
        public async Task<ActionResult<PostUpdateCommandResponse>> CreatePost([FromBody] PostCreateCommand request)
        {
        ...
        [HttpGet("[action]/{id}")]
        public async Task<ActionResult<PostDeleteCommandResponse>> GetPostDetail(string id)
        {
